...
namespace SchoolManagement.Controllers
{
    public class FilieresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_filiere,name_filiere")] Filiere filiere)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_filiere,name_filiere")] Filiere filiere)
        {
            if (ModelState.IsValid)
            {
